...
class CTkBaseClass(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    ...
    def _detect_color_of_master(self, master_widget=None) -> Union[str, Tuple[str, str]]:
        ...
        if isinstance(master_widget, (windows.widgets.core_widget_classes.CTkBaseClass, windows.CTk, windows.CTkToplevel, windows.widgets.ctk_scrollable_frame.CTkScrollableFrame, windows.widgets.ctk_dual_scrollable_frame.CTkDualScrollableFrame)):
