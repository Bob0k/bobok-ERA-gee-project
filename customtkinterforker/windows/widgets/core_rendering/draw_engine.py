...
class DrawEngine:
    ...
    def draw_rounded_rect_with_border(self, width: Union[float, int], height: Union[float, int], corner_radius: Union[float, int],
                                      border_width: Union[float, int], overwrite_preferred_drawing_method: str = None, bottom_not_rounded: bool = False) -> bool:
        ...
        if preferred_drawing_method == "polygon_shapes":
            ...
            return self.__draw_rounded_rect_with_border_font_shapes(width, height, corner_radius, border_width, inner_corner_radius, (), bottom_not_rounded=bottom_not_rounded)
    ...
    def __draw_rounded_rect_with_border_font_shapes(self, width: int, height: int, corner_radius: int, border_width: int, inner_corner_radius: int,
                                                    exclude_parts: tuple, bottom_not_rounded: bool = False) -> bool:
        requires_recoloring = False
        ...
        if inner_corner_radius > 0:
            ...
            if bottom_not_rounded:
                temp = inner_corner_radius
                inner_corner_radius = 0
