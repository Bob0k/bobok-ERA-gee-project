...
class CTkDualScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
                 master: Any,
                 width: int = 200,
                 height: int = 200,
        ...
        self._scrollbar_h = CTkScrollbar(master=self._parent_frame, orientation="horizontal",
        ...
        self._scrollbar_v = CTkScrollbar(master=self._parent_frame, orientation="vertical",
                                         command=self._parent_canvas.yview,
                                         fg_color=scrollbar_fg_color, button_color=scrollbar_button_color,
                                         button_hover_color=scrollbar_button_hover_color)
        self._parent_canvas.configure(xscrollcommand=self._scrollbar_h.set,
    ...
    def _create_grid(self):
        ...
        self._scrollbar_h.grid(row=2, column=0, sticky="nsew", padx=border_spacing)
        self._scrollbar_v.grid(row=1, column=1, sticky="nsew", pady=border_spacing)
    ...
    def configure(self, **kwargs):
        ...
        if "scrollbar_fg_color" in kwargs:
            self._scrollbar_h.configure(fg_color=kwargs.pop("scrollbar_fg_color"))
            self._scrollbar_v.configure(fg_color=kwargs.pop("scrollbar_fg_color"))

        if "scrollbar_button_color" in kwargs:
            self._scrollbar_h.configure(button_color=kwargs.pop("scrollbar_button_color"))
            self._scrollbar_v.configure(button_color=kwargs.pop("scrollbar_button_color"))

        if "scrollbar_button_hover_color" in kwargs:
            self._scrollbar_h.configure(button_hover_color=kwargs.pop("scrollbar_button_hover_color"))
            self._scrollbar_v.configure(button_hover_color=kwargs.pop("scrollbar_button_hover_color"))
    ...
    def cget(self, attribute_name: str):
        if attribute_name == "width":
            ...
            return self._scrollbar_h.cget("fg_color")
        elif attribute_name.startswith("scrollbar_button_color"):
            return self._scrollbar_h.cget("button_color")
        elif attribute_name.startswith("scrollbar_button_hover_color"):
            return self._scrollbar_h.cget("button_hover_color")
    ...
    def _fit_frame_dimensions_to_canvas(self, event):
        ...
        # h, w = self._parent_canvas.winfo_height(), self._parent_canvas.winfo_width()
        # self._parent_canvas.itemconfigure(self._create_window_id, height=h)
