...
class CTkToolTip(Toplevel):
    ...
    def __init__(
        ...
        self.bg_color = ThemeManager.theme["CTkFrame"]["fg_color"] if bg_color is None else bg_color
        ...
        self.frame = CTkFrame(self.transparent_frame, bg_color=self.transparent_color,
