...
# e.g. 79121.1833, 47203.0633 is OSM coordinates
#           44.89, 37.31      is decimal coordinates
# self.map_widget.upper_left_tile_pos and lower_right_tile_pos is in OSM
# self.map_widget.get_position() is in decimal
